...
async def send(ctx,*,msg):
	...
	for member in ctx.guild.members:
		try:
			...
			embed.set_footer(text="Made ❤️ By SƈσυƚGυɾυ™",icon_url="https://cdn.discordapp.com/attachments/713095989593899068/720095371753291797/JPEG_20200606_170941.jpg")
...
bot.run('NjM4NjA2MjYwNjE0MjAxMzQ1.XbfKbQ.RGHo0f7X3dkcHOiZvdWzuqsEZLI')
